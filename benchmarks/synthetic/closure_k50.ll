; ModuleID = 'closure_k50.ll'
source_filename = "closure_k50.c"
...
d_29:
  ...
  br i1 %dc_29, label %p_29, label %d_30

d_30:
  %dc_30 = icmp eq i32 %cond, 30
  br i1 %dc_30, label %p_30, label %d_31

d_31:
  %dc_31 = icmp eq i32 %cond, 31
  br i1 %dc_31, label %p_31, label %d_32

d_32:
  %dc_32 = icmp eq i32 %cond, 32
  br i1 %dc_32, label %p_32, label %d_33

d_33:
  %dc_33 = icmp eq i32 %cond, 33
  br i1 %dc_33, label %p_33, label %d_34

d_34:
  %dc_34 = icmp eq i32 %cond, 34
  br i1 %dc_34, label %p_34, label %d_35

d_35:
  %dc_35 = icmp eq i32 %cond, 35
  br i1 %dc_35, label %p_35, label %d_36

d_36:
  %dc_36 = icmp eq i32 %cond, 36
  br i1 %dc_36, label %p_36, label %d_37

d_37:
  %dc_37 = icmp eq i32 %cond, 37
  br i1 %dc_37, label %p_37, label %d_38

d_38:
  %dc_38 = icmp eq i32 %cond, 38
  br i1 %dc_38, label %p_38, label %d_39

d_39:
  %dc_39 = icmp eq i32 %cond, 39
  br i1 %dc_39, label %p_39, label %d_40

d_40:
  %dc_40 = icmp eq i32 %cond, 40
  br i1 %dc_40, label %p_40, label %d_41

d_41:
  %dc_41 = icmp eq i32 %cond, 41
  br i1 %dc_41, label %p_41, label %d_42

d_42:
  %dc_42 = icmp eq i32 %cond, 42
  br i1 %dc_42, label %p_42, label %d_43

d_43:
  %dc_43 = icmp eq i32 %cond, 43
  br i1 %dc_43, label %p_43, label %d_44

d_44:
  %dc_44 = icmp eq i32 %cond, 44
  br i1 %dc_44, label %p_44, label %d_45

d_45:
  %dc_45 = icmp eq i32 %cond, 45
  br i1 %dc_45, label %p_45, label %d_46

d_46:
  %dc_46 = icmp eq i32 %cond, 46
  br i1 %dc_46, label %p_46, label %d_47

d_47:
  %dc_47 = icmp eq i32 %cond, 47
  br i1 %dc_47, label %p_47, label %d_48

d_48:
  %dc_48 = icmp eq i32 %cond, 48
  br i1 %dc_48, label %p_48, label %d_49

d_49:
  %dc_49 = icmp eq i32 %cond, 49
  br i1 %dc_49, label %p_49, label %x_0
...
p_30:
  %pc_30 = icmp sgt i32 %cond, 30
  br i1 %pc_30, label %x_0, label %y_0

p_31:
  %pc_31 = icmp sgt i32 %cond, 31
  br i1 %pc_31, label %x_0, label %y_0

p_32:
  %pc_32 = icmp sgt i32 %cond, 32
  br i1 %pc_32, label %x_0, label %y_0

p_33:
  %pc_33 = icmp sgt i32 %cond, 33
  br i1 %pc_33, label %x_0, label %y_0

p_34:
  %pc_34 = icmp sgt i32 %cond, 34
  br i1 %pc_34, label %x_0, label %y_0

p_35:
  %pc_35 = icmp sgt i32 %cond, 35
  br i1 %pc_35, label %x_0, label %y_0

p_36:
  %pc_36 = icmp sgt i32 %cond, 36
  br i1 %pc_36, label %x_0, label %y_0

p_37:
  %pc_37 = icmp sgt i32 %cond, 37
  br i1 %pc_37, label %x_0, label %y_0

p_38:
  %pc_38 = icmp sgt i32 %cond, 38
  br i1 %pc_38, label %x_0, label %y_0

p_39:
  %pc_39 = icmp sgt i32 %cond, 39
  br i1 %pc_39, label %x_0, label %y_0

p_40:
  %pc_40 = icmp sgt i32 %cond, 40
  br i1 %pc_40, label %x_0, label %y_0

p_41:
  %pc_41 = icmp sgt i32 %cond, 41
  br i1 %pc_41, label %x_0, label %y_0

p_42:
  %pc_42 = icmp sgt i32 %cond, 42
  br i1 %pc_42, label %x_0, label %y_0

p_43:
  %pc_43 = icmp sgt i32 %cond, 43
  br i1 %pc_43, label %x_0, label %y_0

p_44:
  %pc_44 = icmp sgt i32 %cond, 44
  br i1 %pc_44, label %x_0, label %y_0

p_45:
  %pc_45 = icmp sgt i32 %cond, 45
  br i1 %pc_45, label %x_0, label %y_0

p_46:
  %pc_46 = icmp sgt i32 %cond, 46
  br i1 %pc_46, label %x_0, label %y_0

p_47:
  %pc_47 = icmp sgt i32 %cond, 47
  br i1 %pc_47, label %x_0, label %y_0

p_48:
  %pc_48 = icmp sgt i32 %cond, 48
  br i1 %pc_48, label %x_0, label %y_0

p_49:
  %pc_49 = icmp sgt i32 %cond, 49
  br i1 %pc_49, label %x_0, label %y_0
